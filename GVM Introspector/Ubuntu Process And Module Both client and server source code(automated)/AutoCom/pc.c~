...
char word[30],word1[30],line[20480],command[50],command2[50],word2[30], wait[30];
...
int main(int argc,char *argv[])
{
	...
	/*int fill = open("DOM0.txt", O_CREAT|O_WRONLY, S_IRWXU);
	fp = fopen("db.txt", "r");
    	if (fp == NULL) 
	{
        	printf("Error\n");
	...
	if(strcmp(fname,"aaa")==0)
	{
		...
		char* moc = "./pw";
		system(moc);
		printf("enter any string of length six character\n");
		scanf("%s",wait);
		char* com = "./PS";
    		system(com);
	}
